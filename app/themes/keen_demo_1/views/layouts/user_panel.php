			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('<?= Url::to(['file/display', 'token' => '', 'user' => true]) ?>"></div>
					...
					<div class="d-flex flex-column">
						...
						<div class="text-muted mt-1"><?= Yii::$app->user->identity->email ?></div>
						<div class="navi mt-1">
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<?php //echo Html::a('<div class="navi-link">
					// 		<div class="symbol symbol-40 bg-light mr-3">
					// 			<div class="symbol-label">
					...
					// 			<div class="text-muted">Profile Details</div>
					// 		</div>
					// 	</div>', ['user/profile'], ['class' => 'navi-item']) ?>
				...
				<!--begin::Notifications-->
					<?php //echo $this->render('user_panel_views/notifications') ?>
				<!--end::Notifications-->
